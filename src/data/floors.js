...
export const FLOORS = [
  {
    ...
    name: 'Tidepool Ruins',
    tileset: 'ocean',
    width: 22, height: 29, tiles: FLOOR_2_TILES, startX: 11, startY: 27,
    ...
    objects: [
      ...
      { type: 'valve',     x: 3,  y: 6 },
      { type: 'valve',     x: 8,  y: 14 },
      { type: 'valve',     x: 18, y: 24 },
      // Boss & exit in marsh zone (top-left)
      { type: 'boss',      x: 3,  y: 3, enemyId: 'pressure' },
      { type: 'golden',    x: 1,  y: 1 },
      { type: 'exit',      x: 4,  y: 1 },
      // Chests across zones
      { type: 'chest',     x: 5,  y: 5,  loot: { gold: 20 } },
      { type: 'chest',     x: 13, y: 17, loot: { gold: 20 } },
      // Gold pickups
      { type: 'gold',      x: 7,  y: 8 },
      { type: 'gold',      x: 16, y: 21 },
      // Potions
      ...
      { type: 'encounter', x: 10, y: 11 },
      { type: 'encounter', x: 12, y: 13 },
      { type: 'encounter', x: 15, y: 17 },
      { type: 'encounter', x: 17, y: 19 },
  ...
  },
  {
    ...
    objects: [
      ...
      { type: 'encounter', x: 12, y: 23 },
      { type: 'encounter', x: 1,  y: 15 },
      { type: 'encounter', x: 21, y: 29 },
      { type: 'boss',      x: 11, y: 2, enemyId: 'skywhale' },
      { type: 'exit',      x: 13, y: 1 },
    ],
  },
  {
