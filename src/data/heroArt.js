...
color: '#2e4e88', cardBg: '#181828', topExt: 80, botExt: 78,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={d:'#0e0e18',b:'#181828',m:'#282840',accent:'#800020',accentL:'#c03030',gold:'#806000',gL:'#b08820'};
...
color: '#2e5c2e', cardBg: '#0a140a', topExt: 80, botExt: 78,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={d:'#1e3a1e',b:'#2e5c2e',m:'#488848',gold:'#c07818',gL:'#e09a28',red:'#8c1c1c',rL:'#b82828',cream:'#f0e8d0',dark:'#0a140a',glow:'#e8b040'};
...
color: '#3c2c60', cardBg: '#120c20', topExt: 80, botExt: 78,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={d:'#2a1e40',b:'#3c2c60',m:'#504088',gold:'#c88020',gL:'#eaa030',cream:'#f4eedc',dark:'#120c20',glow:'#f0e040'};
...
color: '#5c2c10', cardBg: '#180a04', topExt: 82, botExt: 80,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={d:'#3a1a0c',b:'#5c2c10',m:'#8c4820',gold:'#c07010',gL:'#e09020',dark:'#180a04',metal:'#2a3440',metalL:'#4a5a70',glow:'#e09020'};
...
color: '#2e4e88', cardBg: '#0e1828', topExt: 84, botExt: 78,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={d:'#1a2e50',b:'#2e4e88',m:'#4a6eaa',l:'#7898cc',gold:'#b87818',gL:'#dca030',red:'#802020',rL:'#aa3830',cream:'#f0e4c8',dark:'#0e1828',glow:'#eec040'};
...
color: '#0e1832', cardBg: '#060810', topExt: 80, botExt: 74,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={robe:'#0e1832',robeM:'#162448',robeL:'#22386a',hat:'#0a1228',stars:'#e8e0b0',gold:'#b07810',gL:'#d8a020',cream:'#f0e4c8',dark:'#06080e',trim:'#d0c880'};
...
L([[-44,-20],[-38,-20],[-34,58],[-40,58]],c.dark,30,{sx:3,sy:5,sp:12,sa:0.42});
L([[-40,-36],[-34,-42],[-28,-36],[-32,-28],[-38,-28]],c.trim,32,{sx:3,sy:5,sp:11,sa:0.4});
glow(-36,-34,7,7,'#80c0f8',0.5,6);
...
color: '#2a3a18', cardBg: '#0c1408', topExt: 80, botExt: 74,
draw: function(R,cx,cy,sc){
var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;
G.save();G.translate(cx,cy);G.scale(sc,sc);
var c={robe:'#2a3a18',robeM:'#3c5422',hat:'#1c2c10',brown:'#4a3010',gold:'#b07010',cream:'#f0e4c8',dark:'#0c140a',leaf:'#3a6020',leafL:'#60a030',owl:'#6a5030',owlL:'#8a7048'};
...
{name:'W3: SPELLBLADE',id:'wizard-spellblade',trait:'Magic fists. Still counts.',color:'#1e3040',cardBg:'#0c1820',topExt:76,botExt:72,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={robe:'#1e3040',robeM:'#2c4862',armor:'#283848',gold:'#b87010',orb:'#a030b0',orbL:'#d060e0',cream:'#f0e4c8',dark:'#0c1820',hat:'#182028'};L([[-24,2],[24,2],[26,64],[-26,64]],c.robe,1,{sx:5,sy:8,sp:21,sa:.42});L([[-32,62],[32,62],[32,68],[-32,68]],c.gold,4,{sx:2,sy:4,sp:8,sa:.34});L([[-22,-8],[22,-8],[24,16],[-24,16]],c.armor,20,{sx:4,sy:6,sp:16,sa:.44});L([[-32,-12],[-16,-22],[-8,-14],[-14,-1]],c.armor,22,{sx:3,sy:5,sp:12,sa:.38});L([[16,-22],[32,-12],[14,-1],[8,-14]],c.armor,23,{sx:3,sy:5,sp:12,sa:.38});L([[-24,2],[-34,-14],[-42,-10],[-38,6],[-26,13]],c.robe,10,{sx:3,sy:5,sp:12,sa:.36});L([[24,2],[34,-14],[42,-10],[38,6],[26,13]],c.robe,12,{sx:3,sy:5,sp:12,sa:.36});Ld(40,-22,12,c.orb,31,{sx:2,sy:4,sp:8,sa:.36});Ld(40,-22,7,c.orbL,32,{sx:1,sy:2,sp:4,sa:.24});glow(40,-22,13,13,c.orbL,.7,8);Ld(0,-9,12,c.cream,40,{sx:3,sy:4,sp:10,sa:.34});Ld(-3,-9,2.8,c.dark,41,{ns:true});Ld(3,-9,2.8,c.dark,42,{ns:true});L([[-20,-9],[20,-9],[18,-24],[12,-32],[0,-36],[-12,-32],[-18,-24]],c.hat,50,{sx:4,sy:7,sp:18,sa:.46});G.restore();}},
{name:'W4: BOOKWORM',id:'wizard-bookworm',trait:'Knows every spell. Uses them all.',color:'#3a2a1c',cardBg:'#14090e',topExt:80,botExt:74,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={robe:'#3a2a1c',robeM:'#5c4030',hat:'#2a1c0e',gold:'#c07818',gL:'#e09a28',cream:'#f0e4c8',dark:'#14090e',book:'#8a2010',bookL:'#b03020',glass:'#a0c8d0'};L([[-28,4],[28,4],[32,66],[-32,66]],c.robe,1,{sx:5,sy:8,sp:23,sa:.42});L([[-32,62],[32,62],[32,68],[-32,68]],c.gold,4,{sx:2,sy:4,sp:9,sa:.34});L([[-28,4],[-42,-8],[-48,-4],[-40,9],[-28,12]],c.robe,10,{sx:3,sy:5,sp:12,sa:.36});L([[28,4],[42,-8],[48,-4],[40,9],[28,12]],c.robe,12,{sx:3,sy:5,sp:12,sa:.36});L([[-50,-2],[-28,-6],[-26,16],[-48,16]],c.book,30,{sx:4,sy:6,sp:13,sa:.44});L([[-48,0],[-30,-4],[-28,14],[-46,14]],c.bookL,31,{sx:2,sy:3,sp:8,sa:.28});L([[34,-12],[38,-12],[40,18],[36,18]],c.dark,60,{sx:2,sy:4,sp:8,sa:.36});Ld(36,-16,6,c.gL,61,{sx:2,sy:3,sp:6,sa:.36});glow(36,-16,5,5,'#e0c040',.58,4);Ld(0,-7,13,c.cream,40,{sx:3,sy:4,sp:11,sa:.36});Ld(-5,-7,3.2,c.dark,41,{ns:true});Ld(5,-7,3.2,c.dark,42,{ns:true});L([[-11,-8],[-1,-8],[-1,-4],[-11,-4]],c.glass,43,{sx:1,sy:2,sp:5,sa:.3});L([[1,-8],[11,-8],[11,-4],[1,-4]],c.glass,44,{sx:1,sy:2,sp:5,sa:.3});L([[-20,-8],[20,-8],[14,-30],[0,-56],[-14,-30]],c.hat,50,{sx:4,sy:7,sp:19,sa:.48});G.restore();}},
{name:'W5: GRAND MAGE',id:'wizard-grandmage',trait:'Ancient power. Zero patience.',color:'#2a1e40',cardBg:'#120c20',topExt:84,botExt:76,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={robe:'#2a1e40',robeM:'#3c2c60',hat:'#1c1428',gold:'#c88020',gL:'#eaa030',cream:'#f4eedc',dark:'#120c20'};L([[-22,-4],[22,-4],[28,60],[-28,60]],c.cream,1,{sx:5,sy:8,sp:22,sa:.4});L([[18,-4],[26,-4],[26,62],[18,62]],c.robe,2,{sx:2,sy:4,sp:10,sa:.3});L([[-26,-4],[-18,-4],[-18,62],[-26,62]],c.robe,3,{sx:2,sy:4,sp:10,sa:.3});L([[-26,54],[26,54],[26,62],[-26,62]],c.gold,4,{sx:2,sy:4,sp:9,sa:.34});L([[-20,-12],[20,-12],[20,18],[-20,18]],c.robe,30,{sx:4,sy:6,sp:16,sa:.44});L([[-38,-14],[-14,-26],[-5,-17],[-14,-1],[-36,-1]],c.robe,50,{sx:3,sy:5,sp:15});L([[14,-26],[38,-14],[36,-1],[5,-17]],c.robe,54,{sx:3,sy:5,sp:15});L([[-22,-4],[-34,-18],[-42,-14],[-36,6],[-24,13]],c.robe,10,{sx:3,sy:5,sp:13,sa:.36});L([[22,-4],[34,-18],[42,-14],[36,6],[24,13]],c.robe,12,{sx:3,sy:5,sp:13,sa:.36});L([[32,-74],[38,-74],[38,56],[32,56]],c.robeM,80,{sx:3,sy:5,sp:13,sa:.38});Ld(35,-78,10,c.gold,83,{sx:2,sy:3,sp:7,sa:.36});Ld(35,-78,6,c.gL,84,{sx:1,sy:2,sp:4,sa:.26});glow(35,-78,11,11,c.gL,.58,7);Ld(0,-9,12,c.cream,40,{sx:3,sy:4,sp:10,sa:.34});Ld(-3,-9,2.5,c.dark,41,{ns:true});Ld(3,-9,2.5,c.dark,42,{ns:true});L([[-26,-8],[26,-8],[26,-5],[-26,-5]],c.hat,50,{sx:2,sy:4,sp:8,sa:.36});L([[-16,-8],[16,-8],[8,-40],[0,-78],[-8,-40]],c.hat,51,{sx:4,sy:7,sp:20,sa:.5});G.save();G.fillStyle=c.gL;G.globalAlpha=.65;[[0,-48],[7,-30],[-7,-34],[3,-62],[-3,-58]].forEach(function(p,i){G.save();G.translate(p[0],p[1]);G.rotate(i*.7);G.beginPath();for(var k=0;k<5;k++){var a=k*Math.PI*2/5-Math.PI/2;G.lineTo(Math.cos(a)*4,Math.sin(a)*4);a+=Math.PI/5;G.lineTo(Math.cos(a)*2,Math.sin(a)*2);}G.closePath();G.fill();G.restore();});G.restore();G.restore();}},
];
export var BUNNIES = [
{name:'B1: PEPPER',id:'bunny-pepper',trait:'Tiny. Fast. Absolutely feral.',color:'#c83030',cardBg:'#1a0808',topExt:76,botExt:72,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={fur:'#e8d8c0',furD:'#c8b090',dark:'#1a0e08',red:'#9c2020',redL:'#cc3030',eye:'#1a0808',nose:'#e88080'};L([[-24,20],[-10,16],[-8,52],[-24,54]],c.furD,10,{sx:3,sy:5,sp:12});L([[10,16],[24,20],[24,54],[8,52]],c.furD,11,{sx:3,sy:5,sp:12});L([[-26,50],[-8,48],[-6,62],[-10,65],[-28,63]],c.furD,20,{sx:3,sy:4,sp:11});L([[8,48],[26,50],[28,63],[10,65],[6,62]],c.furD,21,{sx:3,sy:4,sp:11});Ld(0,10,22,c.furD,1,{sx:4,sy:6,sp:18,sa:.4});Ld(0,10,19,c.fur,2,{sx:3,sy:4,sp:13,sa:.3});L([[-18,-4],[18,-4],[20,4],[-20,4]],c.red,40,{sx:2,sy:4,sp:10,sa:.4});L([[-20,4],[-38,10],[-42,6],[-32,-8],[-20,4]],c.furD,30,{sx:3,sy:5,sp:12,sa:.38});L([[20,-2],[32,-18],[40,-14],[34,2],[20,8]],c.furD,32,{sx:3,sy:5,sp:12,sa:.38});Ld(-38,6,11,c.fur,71,{sx:2,sy:3,sp:7,sa:.3});Ld(38,-12,10,c.fur,72,{sx:2,sy:3,sp:7,sa:.3});Ld(2,-14,17,c.furD,50,{sx:4,sy:6,sp:16,sa:.42});Ld(2,-14,14,c.fur,51,{sx:3,sy:4,sp:12,sa:.3});L([[-12,-28],[-4,-28],[-2,-58],[-10,-60]],c.furD,53,{sx:3,sy:5,sp:14,sa:.4});L([[6,-26],[14,-24],[22,-48],[14,-52]],c.furD,56,{sx:3,sy:5,sp:14,sa:.4});Ld(-5,-16,4,'#f0e8d8',60,{sx:2,sy:3,sp:6,sa:.34});Ld(-5,-16,2.8,c.eye,61,{ns:true});Ld(7,-15,4,'#f0e8d8',62,{sx:2,sy:3,sp:6,sa:.34});Ld(7,-15,2.8,c.eye,63,{ns:true});Ld(1,-10,3,c.nose,66,{sx:1,sy:1,sp:3,sa:.28});G.restore();}},
{name:'B2: NOVA',id:'bunny-nova',trait:'She sparkles. Then she wins.',color:'#8830b8',cardBg:'#180c28',topExt:80,botExt:72,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={fur:'#d8c8f0',furD:'#b0a0d0',dark:'#180c28',plum:'#6020a0',plumL:'#9040d0',nose:'#e090e0',eye:'#180c20',star:'#f0e040'};L([[-24,0],[24,0],[32,58],[28,62],[-28,62],[-32,58]],c.plum,1,{sx:5,sy:8,sp:22,sa:.4});L([[-8,36],[-2,34],[0,60],[-8,62]],c.furD,10,{sx:3,sy:5,sp:12});L([[4,34],[20,28],[28,36],[16,46],[4,44]],c.furD,13,{sx:3,sy:5,sp:13,sa:.38});Ld(0,14,20,c.furD,5,{sx:4,sy:6,sp:16,sa:.4});Ld(0,14,17,c.fur,6,{sx:3,sy:4,sp:12,sa:.3});L([[-20,6],[-36,14],[-40,10],[-34,-4],[-20,4]],c.furD,30,{sx:3,sy:5,sp:12,sa:.38});L([[18,4],[26,-14],[36,-32],[42,-28],[32,-10],[22,8]],c.furD,32,{sx:3,sy:5,sp:13,sa:.4});L([[34,-30],[38,-30],[46,-58],[42,-58]],c.plum,34,{sx:2,sy:4,sp:8,sa:.38});G.save();G.fillStyle=c.star;G.globalAlpha=.92;G.save();G.translate(44,-62);G.rotate(.3);G.beginPath();for(var k=0;k<5;k++){var a=k*Math.PI*2/5-Math.PI/2;G.lineTo(Math.cos(a)*12,Math.sin(a)*12);a+=Math.PI/5;G.lineTo(Math.cos(a)*6,Math.sin(a)*6);}G.closePath();G.fill();G.restore();G.restore();glow(44,-62,14,14,c.star,.6,8);Ld(0,-8,17,c.furD,50,{sx:4,sy:6,sp:15,sa:.42});Ld(0,-8,14,c.fur,51,{sx:3,sy:4,sp:11,sa:.3});L([[-14,-24],[-6,-22],[-4,-58],[-12,-60]],c.furD,53,{sx:3,sy:5,sp:14,sa:.38});L([[6,-22],[14,-24],[18,-60],[10,-60]],c.furD,56,{sx:3,sy:5,sp:14,sa:.38});Ld(-5,-9,4.5,'#f0e8fc',62,{sx:2,sy:3,sp:6,sa:.32});Ld(-5,-9,3,c.eye,63,{ns:true});Ld(6,-9,4.5,'#f0e8fc',64,{sx:2,sy:3,sp:6,sa:.32});Ld(6,-9,3,c.eye,65,{ns:true});Ld(0,-4,2.8,c.nose,66,{sx:1,sy:1,sp:3,sa:.26});G.restore();}},
{name:'B3: BOULDER',id:'bunny-boulder',trait:'Heaviest punch in the kingdom.',color:'#3a3a50',cardBg:'#14100c',topExt:72,botExt:72,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={fur:'#c8c0b0',furD:'#a09888',dark:'#14100c',slate:'#2a3440',slateL:'#3c4e62',gold:'#b07010',nose:'#c0a090',eye:'#100e14'};L([[-26,22],[-10,20],[-9,54],[-26,56]],c.slate,10,{sx:3,sy:5,sp:14});L([[10,20],[26,22],[26,56],[9,54]],c.slate,11,{sx:3,sy:5,sp:14});L([[-28,52],[-8,50],[-6,64],[-10,68],[-30,66]],c.dark,20,{sx:3,sy:4,sp:12});L([[8,50],[28,52],[30,66],[10,68],[6,64]],c.dark,21,{sx:3,sy:4,sp:12});L([[-28,0],[28,0],[30,24],[-30,24]],c.slate,1,{sx:4,sy:6,sp:19,sa:.44});L([[-28,20],[28,20],[28,28],[-28,28]],c.gold,40,{sx:2,sy:4,sp:10,sa:.38});L([[-28,-2],[-44,10],[-44,20],[-28,22]],c.fur,30,{sx:3,sy:5,sp:13,sa:.38});L([[-22,6],[26,6],[28,16],[-22,16]],c.furD,32,{sx:3,sy:5,sp:12,sa:.4});L([[26,-2],[44,10],[44,20],[26,22]],c.fur,34,{sx:3,sy:5,sp:13,sa:.38});L([[-36,-4],[-16,-12],[-8,-2],[-16,6],[-36,8]],c.slate,50,{sx:3,sy:5,sp:14});L([[16,-12],[36,-4],[36,8],[16,6],[8,-2]],c.slate,52,{sx:3,sy:5,sp:14});Ld(0,-10,18,c.furD,60,{sx:4,sy:6,sp:16,sa:.42});Ld(0,-10,15,c.fur,61,{sx:3,sy:4,sp:12,sa:.3});L([[-14,-26],[-6,-26],[-8,-40],[-16,-40]],c.furD,63,{sx:3,sy:5,sp:11,sa:.4});L([[6,-26],[14,-26],[16,-40],[8,-40]],c.furD,65,{sx:3,sy:5,sp:11,sa:.4});L([[-20,-20],[20,-20],[20,-14],[-20,-14]],c.slate,67,{sx:2,sy:3,sp:8,sa:.38});Ld(-6,-10,4,'#e8e0d0',70,{sx:2,sy:3,sp:6,sa:.32});Ld(-6,-10,2.8,c.eye,71,{ns:true});Ld(6,-10,4,'#e8e0d0',72,{sx:2,sy:3,sp:6,sa:.32});Ld(6,-10,2.8,c.eye,73,{ns:true});Ld(0,-4,3,c.nose,76,{sx:1,sy:1,sp:3,sa:.26});G.restore();}},
{name:'B4: BLAZE',id:'bunny-blaze',trait:'Fire magic. Fire attitude.',color:'#9c2020',cardBg:'#1a0a04',topExt:80,botExt:74,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={fur:'#e8c8a0',furD:'#c8a078',dark:'#1a0a04',red:'#9c1810',orange:'#d04808',yellow:'#f0c018',nose:'#e07060',eye:'#180804'};L([[-20,28],[-6,24],[-4,56],[-20,58]],c.furD,10,{sx:3,sy:5,sp:12});L([[6,24],[20,28],[20,58],[4,56]],c.furD,11,{sx:3,sy:5,sp:12});L([[-22,54],[-4,52],[-2,66],[-6,69],[-24,67]],c.furD,20,{sx:3,sy:4,sp:11});L([[4,52],[22,54],[24,67],[6,69],[2,66]],c.furD,21,{sx:3,sy:4,sp:11});Ld(0,12,21,c.furD,1,{sx:4,sy:6,sp:17,sa:.4});Ld(0,12,18,c.fur,2,{sx:3,sy:4,sp:12,sa:.3});L([[-20,4],[-44,-4],[-48,4],[-38,14],[-20,14]],c.furD,30,{sx:3,sy:5,sp:13,sa:.38});L([[20,4],[44,-4],[48,4],[38,14],[20,14]],c.furD,32,{sx:3,sy:5,sp:13,sa:.38});L([[-44,-2],[-38,-10],[-34,-6],[-38,-14],[-44,-12],[-46,-6]],c.yellow,42,{ns:true});glow(-44,-8,14,12,c.orange,.55,8);L([[44,-2],[38,-10],[34,-6],[38,-14],[44,-12],[46,-6]],c.yellow,45,{ns:true});glow(44,-8,14,12,c.orange,.55,8);Ld(-2,-14,17,c.furD,50,{sx:4,sy:6,sp:15,sa:.42});Ld(-2,-14,14,c.fur,51,{sx:3,sy:4,sp:11,sa:.3});L([[-14,-28],[-6,-28],[-8,-56],[-16,-56]],c.furD,53,{sx:3,sy:5,sp:13,sa:.38});L([[4,-28],[12,-28],[14,-56],[6,-56]],c.furD,57,{sx:3,sy:5,sp:13,sa:.38});L([[-16,-54],[-8,-54],[-10,-66],[-14,-66]],c.red,55,{sx:2,sy:4,sp:9,sa:.38});L([[4,-54],[12,-54],[10,-66],[6,-66]],c.red,59,{sx:2,sy:4,sp:9,sa:.38});glow(-12,-60,5,6,c.orange,.5,5);glow(8,-60,5,6,c.orange,.5,5);Ld(-7,-15,4.5,'#f8e8d8',61,{sx:2,sy:3,sp:6,sa:.32});Ld(-7,-15,3,c.eye,62,{ns:true});Ld(5,-15,4.5,'#f8e8d8',63,{sx:2,sy:3,sp:6,sa:.32});Ld(5,-15,3,c.eye,64,{ns:true});Ld(-1,-9,3,c.nose,67,{sx:1,sy:1,sp:3,sa:.26});G.restore();}},
{name:'B5: DUCHESS',id:'bunny-duchess',trait:'Royal blood. Royal fury.',color:'#1e4a1e',cardBg:'#0a160a',topExt:84,botExt:72,
draw:function(R,cx,cy,sc){var G=R.G,L=R.L,Ld=R.Ld,glow=R.glow;G.save();G.translate(cx,cy);G.scale(sc,sc);var c={fur:'#e8e0d0',furD:'#c8bca8',dark:'#120e08',green:'#1e4a1e',greenL:'#2e7030',gold:'#c07818',gL:'#e09830',nose:'#e8a0a0',eye:'#100e08',crown:'#c07818'};L([[-16,4],[16,4],[18,60],[-18,60]],c.green,1,{sx:5,sy:8,sp:20,sa:.42});L([[-18,56],[18,56],[18,61],[-18,61]],c.gold,3,{sx:2,sy:4,sp:8,sa:.36});L([[-12,58],[-2,56],[0,68],[-4,71],[-14,69]],c.dark,20,{sx:3,sy:4,sp:10});L([[2,56],[12,58],[14,69],[4,71],[0,68]],c.dark,21,{sx:3,sy:4,sp:10});L([[-16,2],[-40,-4],[-44,4],[-36,12],[-16,10]],c.furD,30,{sx:3,sy:5,sp:12,sa:.38});G.save();G.strokeStyle=c.dark;G.lineWidth=3.5;G.lineCap='round';G.beginPath();G.moveTo(-42,-18);G.quadraticCurveTo(-56,0,-42,18);G.stroke();G.strokeStyle=c.gold;G.lineWidth=2;G.beginPath();G.moveTo(-42,-18);G.quadraticCurveTo(-56,0,-42,18);G.stroke();G.restore();G.save();G.strokeStyle='#f4f0e8';G.lineWidth=1.2;G.globalAlpha=.7;G.beginPath();G.moveTo(-42,-18);G.lineTo(-42,18);G.stroke();G.restore();L([[16,2],[44,-6],[50,-2],[44,10],[16,10]],c.furD,32,{sx:3,sy:5,sp:13,sa:.4});G.save();G.strokeStyle=c.dark;G.lineWidth=1.5;G.beginPath();G.moveTo(-42,0);G.lineTo(44,0);G.stroke();G.fillStyle=c.gold;G.beginPath();G.moveTo(-42,0);G.lineTo(-38,-4);G.lineTo(-38,4);G.closePath();G.fill();G.strokeStyle=c.green;G.lineWidth=1.5;G.beginPath();G.moveTo(44,0);G.lineTo(40,-6);G.stroke();G.beginPath();G.moveTo(44,0);G.lineTo(40,6);G.stroke();G.restore();Ld(0,14,16,c.furD,5,{sx:4,sy:5,sp:14,sa:.38});Ld(0,-10,16,c.furD,50,{sx:4,sy:6,sp:15,sa:.42});Ld(0,-10,13,c.fur,51,{sx:3,sy:4,sp:11,sa:.3});L([[-12,-26],[-4,-26],[-6,-64],[-14,-64]],c.furD,53,{sx:3,sy:5,sp:13,sa:.38});L([[4,-26],[12,-26],[14,-64],[6,-64]],c.furD,56,{sx:3,sy:5,sp:13,sa:.38});L([[-16,-24],[16,-24],[16,-19],[-16,-19]],c.crown,59,{sx:2,sy:4,sp:10,sa:.4});L([[-16,-24],[-12,-34],[-8,-24]],c.crown,60,{sx:2,sy:4,sp:9,sa:.38});L([[-3,-24],[0,-36],[3,-24]],c.crown,61,{sx:2,sy:4,sp:9,sa:.38});L([[8,-24],[12,-34],[16,-24]],c.crown,62,{sx:2,sy:4,sp:9,sa:.38});Ld(-12,-34,3.5,c.gL,63,{sx:1,sy:2,sp:5,sa:.36});Ld(0,-36,3.5,c.gL,64,{sx:1,sy:2,sp:5,sa:.36});Ld(12,-34,3.5,c.gL,65,{sx:1,sy:2,sp:5,sa:.36});Ld(-5,-11,4,'#f0ece4',66,{sx:2,sy:3,sp:6,sa:.32});Ld(-5,-11,2.8,c.eye,67,{ns:true});Ld(6,-11,3.5,'#f0ece4',68,{sx:2,sy:3,sp:5,sa:.28});Ld(6,-11,2.2,c.eye,69,{ns:true});Ld(0,-5,2.8,c.nose,72,{sx:1,sy:1,sp:3,sa:.26});G.restore();}},
];
